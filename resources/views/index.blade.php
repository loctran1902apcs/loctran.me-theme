...
{{--  <div class="bg-gray-50 dark:bg-gray-800 rounded-tl-xl sm:rounded-t-xl p-4 pb-6 sm:p-8 lg:p-4 lg:pb-6 xl:p-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8">--}}
{{--    <div class="flex items-center space-x-3.5 sm:space-x-5 lg:space-x-3.5 xl:space-x-5">--}}
{{--      <img src="https://wl-brightside.cf.tsp.li/resize/728x/jpg/6da/fda/2341595205936d49a768166871.jpg" alt="" width="160" height="160" class="flex-none w-20 h-20 rounded-lg bg-gray-100" />--}}
